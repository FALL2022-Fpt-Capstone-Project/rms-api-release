...
public class ContractServiceImpl implements ContractService {
    ...
    public RoomContractDTO roomContract(Long id) {
        ...
        var water = list.stream().filter(x -> x.getServiceId() == (BigInteger.valueOf(SERVICE_WATER))).findAny().orElse(new GeneralServiceDTO());
    ...
    public List<RoomContractDTO> listRoomContract(Long groupId,
        ...
        listContract.forEach(e -> {
            ...
            var water = list.stream().filter(x -> x.getServiceId() == (BigInteger.valueOf(SERVICE_WATER))).findAny().orElse(new GeneralServiceDTO());
            var electrict = list.stream().filter(z -> z.getServiceId() == (BigInteger.valueOf(SERVICE_ELECTRIC))).findAny().orElse(new GeneralServiceDTO());
